...
import { DeleteTrainingAluno } from "@/services/routes/aluno/deleteTrainingAluno"
...
export function ModalDeleteTreinoAluno(data: ModalDeleteAlunoProps) {
        ...
        >
            <div
                ...
                <div className="flex flex-col w-full items-center justify-center pt-1 mt-3">
                    <h1 className="font-poppins font-extrabold text-[20px] text-white max-lg:text-2xl">DELETAR TREINO</h1>
                    <h2 className="font-albert font-medium text-[14px] text-white text-primary-200 text-center max-lg:text-md">Você tem certeza que deseja deletar esse treino?</h2>
                </div>
                <div className="w-full items-center h-1/5 flex justify-center pt-5">
                    <button
                        onClick={async () => {
                            ...
                            data.close()
                            await DeleteTrainingAluno(data.aluno?.id)
                        }}
