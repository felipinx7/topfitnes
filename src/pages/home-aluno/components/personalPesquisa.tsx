...
export function PersonalPesquisa(personal: personalPesquisaDTO) {
  ...
  return (
    ...
    >
      <div className=" flex flex-row gap-2">
        <div
          className="h-16 min-h-16 min-w-16 max-md:w-12 max-md:h-12 w-16 rounded-full bg-verde-100"
 ...
 { /*       <h1 className="text-verde-200 text-xl font-Poppins-Bold w-full">
      ...
      <div className="flex h-full max-lg:w-full items-center justify-end max-md:px-12 gap-4 max-md:items-center max-md:justify-center ">

      <a
        href={`https://wa.me/55${telefone}?text=${mensagem}`}
        className={`${personal.telefone ? "" : "cursor-default  bg-neutras-200"}text-base text-center justify-center flex  shadow-xl whitespace-nowrap wrap-normal text-nowrap text-neutras-100 bg-neutras-300 duration-300 hover:bg-verde-100/50 max-md:text-sm cursor-pointer max-md:w-full font-Poppins-Semibold max-md:p-1 max-md:px-1  p-2 px-4 rounded-[8px]`}
      >
        Entrar em Contato
      </a>
