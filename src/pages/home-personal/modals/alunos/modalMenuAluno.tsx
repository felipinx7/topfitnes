            ...
            <div
                ...
                <div className="flex gap-6 flex-col h-full w-4/5 items-center justify-center">
                    ...
                    <button
                        ...
                        <h1 className="pt-0.5">Vincular aluno</h1>
                    </button>
                    {/* Icone Visualizar*/}
                    <button
                        onClick={() => {
                    ...
                    <button
                        ...
                        <IconeExcluirTreino />
                        <h1 className="pt-0.5">Excluir Aluno</h1>
                    </button>
                </div>
