    ...
    return ReactDOM.createPortal(
        ...
        >
            <div
                ...
                className={`bg-black/80 flex flex-col items-center justify-center px-2 w-[30%] h-[55%] max-md:w-[80%] max-md:max-h-[350px] rounded-lg relative duration-300 ease-in-out ${open ? 'scale-100 opacity-100' : 'scale-125 opacity-0'}`}>
                {IconDelete}
                <div className="flex flex-col w-full items-center justify-center pt-1 mt-3">
                    ...
                    <h2 className="font-albert font-medium text-[14px] text-white text-primary-200 max-md: text-center">Você tem certeza que deseja deletar esse {texto}?</h2>
                </div>
                <div className="w-full items-center h-1/5 flex justify-center pt-5">
                    <button
                        ...
                        className="flex items-center justify-center w-3/5 py-1 font-poppins font-semibold text-white bg-red-500 cursor-pointer hover:bg-red-600 duration-500 text-[18px] rounded-lg max-md:w-4/5">Deletar</button>
                </div>
