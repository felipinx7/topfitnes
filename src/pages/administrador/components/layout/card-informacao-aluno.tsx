...
export default function CardInformacaoAluno(props: DataAluno) {
  ...
  return (
    // container card
    <article className={`w-full ease-in-out h-auto rounded-2xl bg-[#d8ffe2] transition-all duration-500 p-4 flex flex-col gap-0 ${openModal ? "gap-4" : "gap-0"}`}>
      ...
      <div className="w-full ease-in-out duration-500 transition-all flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="group cursor-pointer hover:bg-verde-100 transition-all duration-300 rounded-[5.97px] p-2 flex items-center justify-center">
