...
export default function ModalSair({ isOppen, handleCloseModal, LogoutSistem }: ModalSairProps) {
  return (
    <div
    ...
    >
      ...
      <article className="bg-verde-100 w-[400px] text-center h-[200px] p-4 rounded-3xl flex-col flex items-center justify-center">
          ...
          <div className="flex items-center justify-center gap-6">
            <button onClick={LogoutSistem} className="bg-verde-400 hover:scale-105 hover:shadow-md text-white p-2 px-8 rounded-2xl font-Poppins-Bold hover:bg-verde-500 transition-all duration-300 ease-in-out">
              Sim
            </button>
