...
export default function CardPasso(props: DataCardsLadingPage) {
  return (
    <article className="flex w-auto h-auto hover:scale-105 transition-all duration-[0.5s] ease-in-out p-8 flex-col justify-center items-center bg-neutras-50 border border-neutras-100 backdrop-blur-[10px] gap-8 z-20 rounded-2xl">
